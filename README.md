...
### Caveats
- 145 seperate orders are generated by 2 different customers with 2 distinct user_id at the same time. For the purpose of this analysis, one user id is arbitrarily assigned to for the problematic order_ids, the other is dropped.
